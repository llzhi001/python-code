# -*- coding: utf-8 -*-
# @Author: Michael Fong
# @Date:   2018-03-09 10:13:09
# @Last Modified by:   Michael Fong
# @Last Modified time: 2018-03-09 10:37:50
...
def doit():
    ...
    url = ("http://flights.ctrip.com/domesticsearch/search/SearchFirstRouteFlights?DCity1={}&ACity1={}&SearchType=S&DDate1={}&IsNearAirportRecommond=0").format(DCity1,ACity1,DDate1)        #&LogToken=0dc7fd99662349069c123f0a8bfcae95&rk=7.387068566272421154925&CK=51BF6E070FF329F1DDD90CEF097B4B86&r=0.5811166470511521823610
    try:
